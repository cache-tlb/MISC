...
一个普通的指针式时钟, 上有一只虫子初始在12点, 虫子每一步会顺时针或逆时针移动到相邻的数字上, 每一步的运动方向随机且相互独立. 当虫子刚好到达过所有的数字时结束. 问结束时虫子停在 6 点的概率, 并求结束时步数的期望.

~

解: 考虑更一般的情况. 假设虫子经过 $N$ 步结束在 $k$ 点($k\neq 12$), 虫子要先经过它的左右两个邻居. 假设先在 $t$ 时刻到达了左边邻居, 然后转身绕一圈到达另一个邻居. 这说明虫子在 $t$ 时刻之前达到过哪些点都无关紧要, 因为之后又要路过一遍. 换言之, 只要是以 $k$ 点结束, 无论虫子初始在什么位置, 情况都是一样的. 根据对称性, 给定起始点, 无论结束在哪个点, 情况也是等价的. 意味着结束于每个点的概率都相同, 为 $\dfrac{1}{11}$.

~

虫子达到过的数字在一段连续的圆弧上, 由这个圆弧的长度(包含数字的个数)$L$表示状态, 初始 $L=1$, 现在计算 $L=N$ 到达 $L=N+1$ 平均需要走多少步. 刚到达 $L=N$ 状态时, 虫子一定位于圆弧的两个端点之一. 记圆弧上的数字依次为 $v_1, \cdots, v_N$, 虫子在 $v_k$ 时走出圆弧范围平均需要 $E_k$ 步, 则有:
\begin{align*}
E_1 &= \frac{1}{2}(1+E_2) \\
...
注意到这个方程的解为 $E_k = k\cdot(N+1-k)$. 所以状态从 $L=N$ 转到 $L=N+1$ 需要花费 $E_1=E_N = N$ 步. 因此整个过程到结束的期望步数为 $1+2+\cdots + 11 = 66$ 步.
...
(1) $X_1X_2$ 位置比较靠左, $X_3, \cdots, X_n$ 只能在右侧.
\begin{figure*}[htbp]
\centering
\begin{tikzpicture}[scale=1]
\coordinate[label=below left:$0$] (A) at (0,0);
\coordinate[label=below right:$1$] (B) at (6,0);
\coordinate[label=below:$X_1$] (C) at (1,0);
\coordinate[label=below:$X_2$] (D) at (2.5,0);
\coordinate[] (E) at (4,0);
\draw [line width=1pt,red] (A) -- (C);
\draw [line width=1pt] (C) -- (D);
\draw [line width=1pt,red] (D) -- (E);
\draw [line width=1pt,green] (E) -- (B);
\draw[] (5,0) node[anchor=south] {$X_3\cdots$};
...
(2) $X_1X_2$ 位置比较靠右, $X_3, \cdots, X_n$ 只能在左侧.
\begin{figure*}[htbp]
\centering
\begin{tikzpicture}[scale=1]
\coordinate[label=below left:$0$] (A) at (0,0);
\coordinate[label=below right:$1$] (B) at (6,0);
\coordinate[label=below:$X_1$] (C) at (3.5,0);
\coordinate[label=below:$X_2$] (D) at (5,0);
\coordinate[] (E) at (2,0);
\draw [line width=1pt,red] (B) -- (D);
\draw [line width=1pt] (C) -- (D);
\draw [line width=1pt,red] (C) -- (E);
\draw [line width=1pt,green] (E) -- (A);
\draw[] (1,0) node[anchor=south] {$X_3\cdots$};
\foreach \p in {A,B,C,D,E}
	\fill[fill=black,draw=black,thick] (\p) circle (1pt);
\end{tikzpicture}
\end{figure*}
...
(3) $X_1X_2$ 位置居中, $X_3, \cdots, X_n$ 可能在左右两端.
\begin{figure*}[htbp]
\centering
\begin{tikzpicture}[scale=1]
\coordinate[label=below left:$0$] (A) at (0,0);
\coordinate[label=below right:$1$] (B) at (6,0);
\coordinate[label=below:$X_1$] (C) at (2.5,0);
\coordinate[label=below:$X_2$] (D) at (3.5,0);
\coordinate[] (E) at (1.5,0);
\coordinate[] (F) at (4.5,0);
\draw [line width=1pt,green] (F) -- (B);
\draw [line width=1pt,red] (F) -- (D);
\draw [line width=1pt] (C) -- (D);
\draw [line width=1pt,red] (C) -- (E);
\draw [line width=1pt,green] (E) -- (A);
\draw[] (1,0) node[anchor=south] {$X_3\cdots$};
...
\coordinate[label=below:$1$] (A) at (5,0);
\coordinate[label=left:$1$] (B) at (0,5);
\coordinate[] (C) at (5,5);
\coordinate[] (D) at (0,2.5);
\coordinate[] (E) at (2.5,5);
\coordinate[] (F) at (1.66667,3.3333);
\draw[-Stealth,line width=1pt] (-1,0) -- (6.2,0) node[right] {$X_1$};
\draw[-Stealth,line width=1pt] (0,-1.0) -- (0,6.2) node[above] {$X_2$};
\fill [fill=red!30] (O)--(F)--(D)--cycle;
\fill [fill=green!30] (C)--(E)--(F)--cycle;
\fill [fill=blue!30] (O)--(F)--(C)--cycle;
\draw[line width=1pt] (O) -- (A) -- (C) -- (B) -- cycle;
...
对于情况 (1), 点 $X_3$ 等等可能的范围是 $(2(X_2-X_1)+X_1, 1)$, 即 $(2X_2-X_1, 1)$, 区间长度为 $1-2X_2+X_1$. 对应的概率为
\begin{align*}
...
\draw[-Stealth,line width=1pt] (-1,0) -- (12,0) node[right] {$x$};
...
如果是不持有鬼牌的一方抽牌, 例如情况1, 将有 $\dfrac{1}{n+1}$ 抽到鬼牌, 变成情况3; 有 $\dfrac{n}{n+1}$ 概率抽到普通牌, 变成情况 2, 只是普通牌数量减一.
可以得到递推公式:
...
\draw[-Stealth,line width=1pt] (-1.4,0) -- (1.6,0) node[right] {$x$};
\draw[-Stealth,line width=1pt] (-1,-1.4) -- (-1,1.4) node[above] {$y$};
\begin{scriptsize}
\draw [fill=black] (0,0) circle (0.6pt);
\draw [fill=black] (1,0) circle (0.6pt);
\draw [fill=blue] (-1,0) circle (0.6pt);
\draw [fill=blue] (0.4,0.5) circle (0.6pt);
\end{scriptsize}
\end{tikzpicture}
\end{figure*}
