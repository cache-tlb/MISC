...
由 $\angle EBF = 20\degree + 30\degree = \angle CGD$, $CG = EB$, $DG = FB$ 得 $\triangle CDG \cong \triangle EFB$, 于是 $\angle FEB = \angle DCG = 80\degree = \angle FDB$, 说明 $DFBE$ 四点共圆, 从而 $\angle BDE = \angle BFE = GDC = 50\degree$.
