...
\begin{tikzpicture}[scale=1]
\coordinate[] (O) at (0,0);
\coordinate[] (A) at (-2.828,-2.828);
\coordinate[] (B) at (0,4);
\coordinate[] (C) at (1.859,-3.542);
\coordinate[] (D) at (3.492, 1.952);
\coordinate[] (E) at (-0.19, -0.833);
...
\draw [line width=1pt,blue] (D) -- (E) node [midway,below,sloped] {$\sin\beta\cos\alpha$};
\foreach \p in {A,B,C,D,E,O}
	\fill[fill=black,draw=black,thick] (\p) circle (1.2pt);
\draw pic["$\alpha$",draw,line width=1pt, angle eccentricity=2.0, angle radius=0.5cm] {angle=A--B--C};
\draw pic["$\alpha$",draw,line width=1pt, angle eccentricity=2.0, angle radius=0.5cm] {angle=A--D--C};
