...
\coordinate[label=above:$C$] (C) at (0.482,2.736);
\coordinate[label=below:$D$] (D) at (5.222,0);
\coordinate[label=below:$E$] (E) at (1.872, -5.142);
\draw [line width=1pt] (D) --(C) -- (A) -- (B) -- (C);
%\draw [line width=1pt] (C) -- (A) node [midway,sloped] {$||$};
%\draw [line width=1pt] (B) -- (D) node [near end,sloped] {$||$};
\draw [dashed,line width=1pt] (C) --(E) -- (B);
\draw [dashed,line width=1pt] (A) --(E);
\foreach \p in {A,B,C,D,E}
	\fill[fill=black,draw=black,thick] (\p) circle (1.25pt);
\draw pic["$80\degree$",draw,line width=1pt, angle eccentricity=2.5, angle radius=0.3cm] {angle=B--A--C};
\draw pic[draw,red,line width=1pt, angle eccentricity=2.3, angle radius=0.6cm] {angle=A--C--E};
\draw pic[draw,red,line width=1pt, angle eccentricity=2.3, angle radius=0.6cm] {angle=C--B--A};
\draw pic["$?$",draw,line width=1pt, angle eccentricity=1.5, angle radius=0.6cm] {angle=C--D--A};
\end{tikzpicture}
\end{figure*}

以 $BC$ 为边构造一个等边三角形 $BCE$, 并连接 $AE$. $\angle ABE = \angle CBE - \angle CBA = 40\degree$.
因为 $BA = BC = BE$, 在等腰三角形 $ABE$ 中, $\angle AEB = 70\degree$. $\angle AEC = 10\degree$.

因为 $\angle ACE = \angle ACB - \angle ECB = 80\degree - 60\degree = 20\degree = \angle DBC$, $AC = DB$, $CE = BC$, 所以 $\triangle ACE \cong \triangle DBC$, $\angle DCB = \angle AEC = 10\degree$, $\angle ADC = \angle DCB + \angle DBC = 30\degree$.
...
\begin{tikzpicture}[scale=1]
\coordinate[] (A) at (8,0);
\coordinate[] (B) at (5.222, -0.49);
\coordinate[] (C) at (2.778, -0.921);
\coordinate[] (D) at (0.965, -1.24);
\coordinate[] (E) at (0, -1.411);
\coordinate[] (F) at (5.222, 0.49);
\coordinate[] (G) at (2.778, 0.921);
\coordinate[] (H) at (0.965, 1.24);
\coordinate[] (I) at (0, 1.411);
\coordinate[] (M) at (-2, 1.763);
\coordinate[] (N) at (-2, -1.763);
\draw [line width=1pt] (A) --(B) -- (G) -- (D) -- (I) -- (E) -- (H) -- (C) -- (F) -- cycle;
\draw [dashed,line width=1pt] (B) -- (N);
\draw [dashed,line width=1pt] (F) --(M);
\foreach \p in {A,B,C,D,E,F,G,H,I}
	\fill[fill=black,draw=black,thick] (\p) circle (1.25pt);
\draw pic["$\alpha$",draw,line width=1pt, angle eccentricity=1.5, angle radius=0.6cm] {angle=M--A--N};
\draw pic[draw,line width=1pt,red, angle eccentricity=1.5, angle radius=0.6cm] {angle=G--B--D};
\draw pic[draw,line width=1pt,red, angle eccentricity=1.5, angle radius=0.45cm] {angle=B--D--G};
\draw pic[draw,line width=1pt,green, angle eccentricity=1.5, angle radius=0.3cm] {angle=D--I--G};
\draw pic[draw,line width=1pt,green, angle eccentricity=1.5, angle radius=0.3cm] {angle=I--G--D};
\draw pic[draw,line width=1pt,blue, angle eccentricity=1.5, angle radius=0.25cm] {angle=D--E--I};
\draw pic[draw,line width=1pt,blue, angle eccentricity=1.5, angle radius=0.25cm] {angle=I--D--E};
\end{tikzpicture}
\end{figure*}

假设有两条射线, 夹角为 $\alpha$, 依次如上图连出 9 条线段, 每条线段长度相等, 端点均在两条射线上. 可以求出红色的两个角为 $2\alpha$, 绿色的两个角为 $3\alpha$, 蓝色的两个角为 $4\alpha$. 所以最外层的等腰三角形顶角为 $\alpha$, 底角为 $4\alpha$, 则 $\alpha = 20\degree$. 它的图形正好符合题目的图形, 可以求出各个角度.
...
三个圆交于一点, 半径都是 $r$, 除了三个圆的公共点之外, 每两个点还有另外一个交点.

求证: 这三个另外的交点构成的三角形外接圆半径也是 $r$.
\begin{figure*}[htbp]
\centering
\begin{tikzpicture}[scale=0.8]
\coordinate[] (A) at (0,0);
\coordinate[] (B) at (-2.624, 1.453);
\coordinate[] (C) at (1.892, 2.328);
\coordinate[] (D) at (0.958, -2.843);
\coordinate[] (E) at (-0.732, 3.781);
\coordinate[] (F) at (2.85, -0.515);
\coordinate[] (G) at (-1.667, -1.39);
\coordinate[] (H) at (0.225, 0.938);
\draw [line width=1pt] (B) circle (3);
\draw [line width=1pt] (C) circle (3);
\draw [line width=1pt] (D) circle (3);
\draw [line width=1pt,blue] (H) circle (3);
\draw [line width=1pt,gray] (E) -- (F) -- (G) -- cycle;
\foreach \p in {B,C,D,E,F,G}
	\fill[fill=black,draw=black,thick] (\p) circle (1.25pt);
\end{tikzpicture}
\end{figure*}

解: 设三个圆的圆心分别是 $B,C,D$, 公共交点为 $A$, 每两个圆另外的交点分别为 $E,F,G$. 找到 $A$ 分别关于 $B,C,D$ 对称的点 $I,J,K$.
\begin{figure*}[htbp]
\centering
\begin{tikzpicture}[scale=0.8]
\coordinate[label=below:$A$] (A) at (0,0);
\coordinate[label=below:$B$] (B) at (-2.624, 1.453);
\coordinate[label=below:$C$] (C) at (1.892, 2.328);
\coordinate[label=right:$D$] (D) at (0.958, -2.843);
\coordinate[label=above:$E$] (E) at (-0.732, 3.781);
\coordinate[label=right:$F$] (F) at (2.85, -0.515);
\coordinate[label=below left:$G$] (G) at (-1.667, -1.39);
\coordinate[] (H) at (0.225, 0.938);
\coordinate[label=above left:$I$] (I) at (-5.249, 2.907);
\coordinate[label=above right:$J$] (J) at (3.784, 4.656);
\coordinate[label=below right:$K$] (K) at (1.915, -5.686);
\draw [line width=1pt] (B) circle (3);
\draw [line width=1pt] (C) circle (3);
\draw [line width=1pt] (D) circle (3);
\draw [line width=1pt,blue] (H) circle (3);
\draw [line width=1pt,gray] (E) -- (F) -- (G) -- cycle;
\draw [line width=1pt,dashed] (I) -- (J) -- (K) -- cycle;
\draw [line width=1pt,dashed] (A) -- (I);
\draw [line width=1pt,dashed] (A) -- (J);
\draw [line width=1pt,dashed] (A) -- (K);
\foreach \p in {B,C,D,E,F,G,I,J,K}
	\fill[fill=black,draw=black,thick] (\p) circle (1.25pt);
\end{tikzpicture}
\end{figure*}

则 $AI, AJ, AK$ 是三个圆的直径, $\triangle IJK$ 的外接圆半径为 $2r$. 

另一方面, 因为 $AI, AJ$ 是直径, 所以 $\angle AEI = \angle AEJ = 90\degree$. 进而可得 $\triangle AEI\cong\triangle AEJ$, 于是 $E$ 是 $IJ$ 的中点. 同理可得 $F,G$ 分别是 $JK$ 和 $KI$ 的中点.

所以 $\triangle EFG$ 的外接圆半径是 $\triangle IJK$ 外接圆半径的一半, 为 $r$.
...
\coordinate[label=right:$F$] (F) at (2.85, -0.515);
\coordinate[label=below left:$G$] (G) at (-1.667, -1.39);
\coordinate[label=below:$P$] (P) at (1.131, -5.838);
\coordinate[] (H) at (0.225, 0.938);
\draw [line width=1pt] (B) circle (3);
\draw [line width=1pt] (C) circle (3);
\draw [line width=1pt] (D) circle (3);
...
\draw [line width=1pt,gray] (F) -- (P) -- (G);
\foreach \p in {B,C,D,E,F,G,P}
	\fill[fill=black,draw=black,thick] (\p) circle (1.25pt);
\draw pic["$\alpha$",draw,red,line width=1pt, angle eccentricity=1.5, angle radius=0.4cm] {angle=A--E--F};
\draw pic["$\alpha$",draw,red,line width=1pt, angle eccentricity=1.5, angle radius=0.5cm] {angle=F--G--A};
\draw pic["$\beta$",draw,orange,line width=1pt, angle eccentricity=1.8, angle radius=0.6cm] {angle=A--F--G};
\draw pic["$\beta$",draw,orange,line width=1pt, angle eccentricity=1.8, angle radius=0.6cm] {angle=G--E--A};
\draw pic["$\alpha+\beta$",draw,line width=1pt, angle eccentricity=2.0, angle radius=0.6cm] {angle=F--P--G};
\end{tikzpicture}
\end{figure*}

考虑弦 $AF$, 由正弦定理, 在圆 $C$ 中有 $AF = 2r\sin\angle AEF$, 在圆 $D$ 中有 $AF = 2r\sin\angle AGF$, 由此可得 $\angle AEF = \angle AGF$. 同理在 $AG$ 上由正弦定理可得 $\angle AEG = \angle AFG$.

作 $E$ 关于 $FG$ 对称的点 $P$. 下面证明 $P$ 在圆 $D$ 上. 首先根据对称关系有 $\triangle EFG\cong \triangle PFG$, 所以 
$$\angle FPG = \angle FEG = \angle AEF + \angle AEG = \angle AGF + \angle AFG .$$
两边加上 $\angle FAG$ 得  
$$\angle FPG + \angle FAG = \angle AGF + \angle AFG + \angle FAG = 180\degree .$$
所以 $AFGP$ 四点共圆. $\triangle FPG$ 的外接圆也就是 $\triangle AFG$ 的外接圆, 也就是圆 $D$, 半径为 $r$. 由$\triangle EFG\cong \triangle PFG$, 可知 $\triangle EFG$ 的外接圆半径也是 $r$.

%------------------------------------------------------------------------------%
\newpage
\noindent 密克定理(Miquel's theorem)

三角形三边(或其延长线)上各有任意一点, 每个顶点和邻接的两边上的点构成一组, 共有三组, 每组三个点能确定一个外接圆. 密克定理指出: 这三个外接圆交于同一个点.
\begin{figure*}[htbp]
\centering
\begin{tikzpicture}[scale=1]
\coordinate[label=above:$A$] (A) at (0,3);
...
\coordinate[label=left:$D$] (D) at (-2,1);
\coordinate[label=above right:$E$] (E) at (0.756, -1.073);
\coordinate[label=right:$F$] (F) at (1.079, 1.651);
\coordinate[] (O) at (-0.497, 1.497);
\coordinate[] (P) at (-1.198, -0.802);
\coordinate[] (Q) at (2.834, 0.061);
\coordinate[] (M) at (0.474, 0.245);
\draw [line width=1pt] (O) circle (1.583);
\draw [line width=1pt] (P) circle (1.972);
\draw [line width=1pt] (Q) circle (2.368);
\draw [line width=1pt] (A) -- (B) -- (C) -- cycle;
\foreach \p in {A,B,C,D,E,F,O,P,Q,M}
...
证明: 如图, 设 $A$ 所在的外接圆和 $B$ 所在的外接圆相相交于 $D$ 和 $M$, 下面证明 $CEFM$ 四点共圆.
\begin{figure*}[htbp]
\centering
\begin{tikzpicture}[scale=1]
\coordinate[label=above:$A$] (A) at (0,3);
...
\coordinate[] (P) at (-1.198, -0.802);
\coordinate[] (Q) at (2.834, 0.061);
\coordinate[label=right:$M$] (M) at (0.474, 0.245);
\draw [line width=1pt] (O) circle (1.583);
\draw [line width=1pt] (P) circle (1.972);
\draw [line width=1pt,dashed] (Q) circle (2.368);
\draw [line width=1pt] (A) -- (B) -- (C) -- cycle;
\draw [line width=1pt] (D) -- (M);
\draw [line width=1pt] (E) -- (M);
...
事实上, 由 $ADMF$ 共圆得 $\angle BAC + \angle DMF = 180\degree$, 由 $BDME$ 共圆得 $\angle ABC + \angle DME = 180\degree$. 而另外还有
\begin{align*}
\angle BAC + \angle ABC + \angle ACB &= 180\degree \\
\angle DMF + \angle EMF + \angle DME &= 360\degree
\end{align*}
所以有 $\angle ACB + \angle EMF = 180\degree$, 故 $CEFM$ 共圆, 说明 $\triangle CEF$ 的外接圆也经过 $M$ 点. 从而三个外接圆都交于 $M$点.
...
%------------------------------------------------------------------------------%
\newpage
\noindent Carnot's theorem

任意 $\triangle ABC$, 设外接圆圆心为 $O$, $O$ 到三边的垂足分别为 $D,E,F$, 则 $O$ 到三边的带符号距离之和等于三角形外接圆和内切圆的半径之和:
$$ OD + OE + OF = R+r .$$
带符号距离指的是若 $OD, OE, OF$ 中的某一条完全落在 $\triangle ABC$ 之外, 则对应的距离就是负的. 
\begin{figure*}[htbp]
\centering
\begin{tikzpicture}[scale=0.8]
\coordinate[label=left:$A$] (A) at (0,3);
\coordinate[label=below:$B$] (B) at (4,-1);
\coordinate[label=right:$C$] (C) at (7,1);
\coordinate[label=below:$D$] (D) at (2,1);
\coordinate[label=right:$E$] (E) at (5.5,0);
\coordinate[label=below left:$F$] (F) at (3.5,2);
\coordinate[label=above:$O$] (O) at (3.7,2.7);
\coordinate[label=above:$P$] (P) at (4.154, 0.556);
\coordinate[label=below:$I$] (I) at (3.077, -1.615);
\coordinate[label=below:$G$] (G) at (4.5, -1.5);
\coordinate[label=above:$H$] (H) at (4.755, 1.642);
\draw [line width=1pt] (O) circle (3.712);
\draw [line width=1pt] (P) circle (1.209);
\draw [line width=1pt] (A) -- (B) -- (C) -- cycle;
\draw [line width=1pt] (O) -- (D);
\draw [line width=1pt] (O) -- (E);
\draw [line width=1pt,dashed,green] (A) -- (I) -- (B);
\draw [line width=1pt,dashed,green] (B) -- (G) -- (C);
\draw [line width=1pt,dashed,green] (B) -- (H);
\draw [line width=1pt,dashed] (O) -- (F);
\draw [line width=1pt,red] (A) to [edge label=$R$ ](O);
\draw [line width=1pt,blue] (P) to [edge label=$r$ ](3.3,-0.3);
\foreach \p in {A,B,C,D,E,F,G,H,I,O,P}
	\fill[fill=black,draw=black,thick] (\p) circle (1.2pt);
\end{tikzpicture}
\end{figure*}

证明: 分别过三个顶点作对边的垂线, 垂足分别为 $G,H,I$. 下面的证明中的长度和面积均表示绝对值. 

由内切圆可知
$$ r(AB+BC+CA) = 2S_{\triangle ABC} .$$
另一方面, 考虑面积关系:
$$ S_{\triangle ABC} = S_{\triangle AOB} + S_{\triangle BOC} - S_{\triangle COA}, $$
所以
\[ r(AB+BC+CA) = AB\cdot OD + BC\cdot OE - CA\cdot OF \tag{1} \]

弦 $AB$ 对的圆周角为 $\angle ACB$, 圆心角为 $\angle AOB$, 所以 $\angle AOD = \angle ACB$. 分别在直角三角形 $\triangle AOD$, $\triangle BCH$, $\triangle ACI$ 中求上述角的余弦, 可得 
$$\dfrac{OD}{R} = \dfrac{CH}{BC} = \dfrac{CI}{AC}, $$
进而得
\[ R\cdot(CH+CI) = OD\cdot(BC+AC) \tag{2} \]
类似的还有 $\angle BAC = \angle COE$, 求余弦得
$$\dfrac{OE}{R} = \dfrac{AG}{AC} = \dfrac{AH}{AB}, $$
进而得
\[R\cdot(AG+AH) = OE\cdot(AC+AB)  \tag{3} \]
对 $\angle ABC = \angle AOF = \pi - \angle ABI = \pi - \angle CBG$, 求余弦得
$$ \dfrac{OF}{R} = \dfrac{BI}{AB} = \dfrac{BG}{BC} $$
进而得
\[ R\cdot(BI+BG) = OF\cdot(AB+BC) \tag{4} \]
将 $(2)+(3)-(4)$ 与 $(1)$ 相加得
\[ (r+R)(AB+BC+CA) = (OD+OE-OF)(AB+BC+CA) \]
所以 $OD+OE-OF = r+R$ 成立.
...
设$BC=a, CA=b, AB=c$, 外接圆到三边的距离分别为 $x,y,z$, $\triangle ABC$ 外接圆圆心为 $O$.
\begin{figure*}[htbp]
\centering
\begin{tikzpicture}[scale=0.8]
...
\coordinate[label=below:$D$] (D) at (1.5,0);
\coordinate[label=above right:$E$] (E) at (2.5,2.5);
\coordinate[label=above left:$F$] (F) at (-1,2.5);
\coordinate[label=above:$O$] (O) at (1.5,1.5);
%\draw [line width=1pt] (O) circle (3.808);
\draw [line width=1pt] (A) -- (B) -- (C) -- cycle;
\draw [line width=1pt] (O) to [edge label=$x$] (D);
\draw [line width=1pt] (O)  to [edge label'=$y$] (E);
\draw [line width=1pt] (O) to [edge label=$z$](F);
\tkzMarkRightAngle[line width=1pt](B,F,O);
\tkzMarkRightAngle[line width=1pt](C,D,O);
\tkzMarkRightAngle[line width=1pt](A,E,O);
\foreach \p in {A,B,C,D,E,F,O}
	\fill[fill=black,draw=black,thick] (\p) circle (1.2pt);
\end{tikzpicture}
\end{figure*}

易知 $D,E,F$ 分别是所在边的中点, 且 $AEOF$ 四点共圆, 由托勒密定理得 
\[ AE\cdot OF + AF\cdot OE = AO\cdot EF \]
即
\[ \frac{b}{2}\cdot z + \frac{c}{2}\cdot y = R\cdot \frac{a}{2} \]
同理还有
\begin{align*}
\frac{c}{2}\cdot x + \frac{a}{2}\cdot z &= R\cdot \frac{b}{2}\\
\frac{a}{2}\cdot y + \frac{b}{2}\cdot x &= R\cdot \frac{c}{2}
\end{align*}
三个式子相加, 并令 $2s=a+b+c$:
\begin{align*}
&\quad x(b+c)+y(c+a)+z(a+b)=R(a+b+c)  \\
\Leftrightarrow &\quad x(2s-a)+y(2s-b)+z(2s-c)=2sR \\
\Leftrightarrow &\quad 2s(x+y+z) - (ax+by+cz)=2sR \\
\Leftrightarrow &\quad 2s(x+y+z)-2S_{\triangle ABC}=2sR \\
\Leftrightarrow &\quad 2s(x+y+z) - 2sr=2sR \\
\Leftrightarrow &\quad x+y+z = r+R
\end{align*}
...
\begin{tikzpicture}[scale=1]
\coordinate[] (O) at (0,0);
\coordinate[] (A) at (-2.19, -3.347);
\coordinate[] (B) at (0,4);
\coordinate[] (C) at (1.859,-3.542);
\coordinate[] (D) at (3.97, 0.491);
\coordinate[] (E) at (0.639, -1.584);
\coordinate[] (F) at (-3.97,-0.491);
\draw [line width=1pt] (O) circle (4cm);
\draw [line width=1pt] (A) -- (B) -- (C) -- (E);
\draw [line width=1pt] (B) -- (D);
\draw [line width=1pt,gray] (D) -- (O) -- (F) -- (A);
%\draw [line width=1pt,gray] (O) -- (-4,0) node[midway,above,sloped] {$R=0.5$};
\draw [line width=1pt] (A) -- (C) node [midway,above,sloped] {$\sin\alpha$};
\draw [line width=1pt] (C) -- (D) node [midway,below,sloped] {$\sin\beta$};
\draw [line width=1pt,red] (A) -- (E) node [midway,above,sloped] {$\sin\alpha\cos\beta$};
\draw [line width=1pt,blue] (D) -- (E) node [midway,above,sloped] {$\sin\beta\cos\alpha$};
\foreach \p in {A,B,C,D,E,F,O}
	\fill[fill=black,draw=black,thick] (\p) circle (1.2pt);
\draw pic["$\alpha$",draw,line width=1pt, angle eccentricity=1.6, angle radius=0.45cm] {angle=A--B--C};
\draw pic["$\alpha$",draw,line width=1pt, angle eccentricity=2.0, angle radius=0.4cm] {angle=A--D--C};
\draw pic["$\beta$",draw,line width=1pt, angle eccentricity=2.0, angle radius=0.4cm] {angle=C--B--D};
\draw pic["$\beta$",draw,line width=1pt, angle eccentricity=2.0, angle radius=0.4cm] {angle=C--A--D};
\draw pic["$\alpha+\beta$",draw,gray,line width=1pt, angle eccentricity=2.5, angle radius=0.4cm] {angle=A--F--D};
\tkzMarkRightAngle[line width=1pt](A,E,C);
\tkzMarkRightAngle[line width=1pt,gray](F,A,D);
\end{tikzpicture}
\end{figure*}
...
\coordinate[] (C) at (8,6);
\coordinate[] (D) at (8, 2);
\coordinate[] (E) at (7.158, 5.368);
\coordinate[] (F) at (8, 5.368);
\coordinate[] (G) at (7.158, 0);
\draw [line width=1pt] (A) -- (B);
\draw [line width=1pt] (E) -- (F) -- (C) -- cycle;
\draw [line width=1pt,green] (B) --(D)node [midway,below,sloped] {$\cos\alpha\sin\beta$};
\draw [line width=1pt,red] (D) --(C) node [midway,below,sloped] {$\sin\alpha\cos\beta$};
\draw [line width=1pt,dashed] (E)--(G);
\draw [line width=1pt,blue] (A) -- (E) node [midway,above] {$1$};
\draw [line width=1pt] (A) -- (D) node [midway,above,sloped] {$\cos\alpha$}; 
\draw [line width=1pt] (D) -- (E) node [near start,below,sloped] {$\sin\alpha$};
\foreach \p in {A,B,C,D,E,F,G}
	\fill[fill=black,draw=black,thick] (\p) circle (0.8pt);
\draw pic["$\alpha$",draw,line width=1pt, angle eccentricity=1.8, angle radius=0.6cm] {angle=D--A--E};
\draw pic["$\beta$",draw,line width=1pt, angle eccentricity=1.8, angle radius=1cm] {angle=B--A--D};
\draw pic["$\beta$",draw,line width=1pt, angle eccentricity=1.8, angle radius=0.9cm] {angle=C--D--E};
\tkzMarkRightAngle[line width=1pt](A,G,E);
\tkzMarkRightAngle[line width=1pt](A,B,C);
\tkzMarkRightAngle[line width=1pt](A,D,E);
\tkzMarkRightAngle[line width=1pt](E,F,D);
\draw [line width=1pt,decorate,decoration={brace,mirror,amplitude=5pt,raise=-5pt}] (9,0) -- (9,5.368) node[pos=0.5,rotate=90,anchor=north]{$\sin(\alpha+\beta)$};
\end{tikzpicture}
\end{figure*}
...
\coordinate[] (G) at (7.158, 0);
\draw [line width=1pt] (A) -- (G);
\draw [line width=1pt] (B) --(C) -- (E);
\draw [line width=1pt,dashed] (E)--(G);
\draw [line width=1pt,blue] (A) -- (E) node [midway,above] {$1$};
\draw [line width=1pt] (A) -- (D) node [midway,above,sloped] {$\cos\alpha$}; 
\draw [line width=1pt] (D) -- (E) node [near start,below,sloped] {$\sin\alpha$};
\node [anchor=west,red] at (F) {$\sin\alpha\sin\beta$};
\foreach \p in {A,B,C,D,E,F,G}
	\fill[fill=black,draw=black,thick] (\p) circle (0.8pt);
\draw pic["$\alpha$",draw,line width=1pt, angle eccentricity=1.8, angle radius=0.6cm] {angle=D--A--E};
\draw pic["$\beta$",draw,line width=1pt, angle eccentricity=1.8, angle radius=1cm] {angle=B--A--D};
...
\tkzMarkRightAngle[line width=1pt](A,D,E);
\tkzMarkRightAngle[line width=1pt](E,F,D);
\draw [line width=1pt,red] (E) -- (F) ;
\draw [line width=1pt,red] (G) -- (B) ;
\draw [line width=1pt,decorate,decoration={brace,mirror,amplitude=5pt}] (0,-1) -- (7.158,-1) node[pos=0.5,below=0.1]{$\cos(\alpha+\beta)=\cos\alpha\cos\beta-\sin\alpha\sin\beta$};
\draw [line width=1pt,decorate,decoration={brace,mirror,amplitude=5pt}] (0,-0.2) -- (8,-0.2) node[pos=0.5,below=0.1]{$\cos\alpha\cos\beta$};
\end{tikzpicture}
\end{figure*}
...
\coordinate[] (C) at (8,5);
\coordinate[] (D) at (8, -3);
\coordinate[] (E) at (6.125, 0);
\coordinate[] (F) at (5.37, -2.014);
\fill[fill=orange!20] (C)--(D)--(F)--cycle;
\fill[fill=green!20] (A)--(E)--(F)--cycle;
\draw [line width=1pt] (A) -- (C);
\draw [line width=1pt] (D) -- (F);
\draw [line width=1pt,blue,dashed] (A) --(E)node [midway,above,sloped] {$1-\tan\alpha\tan\beta$};
\draw [line width=1pt] (E) --(B) node [midway,below,sloped] {$\tan\alpha\tan\beta$};
\draw [line width=1pt,blue] (D) --(B) node [midway,below,sloped] {$\tan\beta$};
\tkzMarkRightAngle[line width=1pt](A,B,C);
\tkzMarkRightAngle[line width=1pt](A,F,E);
\tkzMarkRightAngle[line width=1pt](C,F,D);
\draw [line width=1pt,blue] (B) --(C) node [midway,below,sloped] {$\tan\alpha$};
\draw [line width=1pt,red] (C)--(F);
\draw [line width=1pt,red,dashed] (A) --(F);
\foreach \p in {A,B,C,D,E,F}
	\fill[fill=black,draw=black,thick] (\p) circle (0.8pt);
\draw pic["$\alpha$",draw,line width=1pt, angle eccentricity=1.8, angle radius=0.6cm] {angle=B--A--C};
\draw pic["$\beta$",draw,line width=1pt, angle eccentricity=1.8, angle radius=0.8cm] {angle=F--A--E};
\draw pic["$\beta$",draw,line width=1pt, angle eccentricity=1.5, angle radius=0.6cm] {angle=E--C--B};
\draw [line width=1pt,decorate,decoration={brace,mirror,amplitude=5pt,raise=5pt}] (0,-3) -- (8,-3) node[pos=0.5,anchor=north,below=0.3]{$1$};
\draw [line width=1pt,decorate,decoration={brace,mirror,amplitude=5pt,raise=5pt}] (A) -- (F) node[pos=0.47,below=0.4,anchor=north]{$x$};
\draw [line width=1pt,decorate,decoration={brace,mirror,amplitude=5pt,raise=10pt}] (C) -- (F) node[pos=0.43,left=1,anchor=north]{$y$};
\end{tikzpicture}
\end{figure*}
\[ \cos\beta = \frac{x}{1-\tan\alpha\tan\beta} = \frac{y}{\tan\alpha+\tan\beta} \]
\[\tan(\alpha+\beta) = \frac{y}{x} = \frac{\tan\alpha+\tan\beta}{1-\tan\alpha\tan\beta}\]

%------------------------------------------------------------------------------%
\newpage
\noindent 等周问题的 Steiner 四连杆法证明

证明: 相同周长的闭曲线中, 圆的面积最大.

~

解: 假设已经得到了一个面积最大的闭曲线 $l$, 下面研究这个曲线具有怎样的性质. 在曲线上取两点 $A,B$, 将曲线分成长度相等的两段. 不妨设 $AB$ 是水平的, $AB$ 将 $l$ 分成上下两部分, 面积分别为 $S_1, S_2$. 若两部分面积不等, 例如 $S_1 > S_2$, 那么可以将 $S_1$ 沿直线 $AB$ 翻折下去, 替换掉 $S_2$, 得到一个新的封闭曲线, 周长不变但面积更大了. 
...
\fill[draw=red,line width=1pt,fill=red!20] (A) to[curve through = { (-2,2) (-1,2.5) (0,2.5) (1,2.5) (2,2) }] (B);
\fill[draw=blue,line width=1pt,fill=blue!20] (A) to[curve through = { (-2.5,-1) (-1,-2) (0,-3) (1,-2) (2.5,-1) }] (B);
\draw[line width=1pt,red,dashed] (A) to[curve through = { (-2,-2) (-1,-2.5) (0,-2.5) (1,-2.5) (2,-2) }] (B);
\draw[line width=1pt,dashed] (-4,0) -- (4,0);
\foreach \p in {A,B}
	\fill[fill=black,draw=black,thick] (\p) circle (1.0pt);
\draw[] (0,1.5) node {$S_1$};
\draw[] (0,-1.5) node {$S_2$};
...
所以面积最大的闭曲线满足等分周长的两点连线也要等分面积. 继续考虑 $l$ 和 $AB$, 仍然将 $S_1$ 沿 $AB$ 翻折得到 $S_1'$. $S_1$ 和 $S_1'$ 拼成一条新的曲线 $l'$, 它与 $l$ 的周长和面积均相等, 因此也是面积最大的. 
\begin{figure*}[htbp]
\centering
\begin{minipage}[c]{0.49\linewidth}
\begin{tikzpicture}[scale=0.6]
\coordinate[] (NX) at (-4,0);
\coordinate[] (PX) at (6,0);
\coordinate[label=above left:$A$] (A) at (-3,0);
\coordinate[label=above right:$B$] (B) at (5,0);
\coordinate[label=above:$C$] (C) at (0,4);
\coordinate[label=below:$D$] (D) at (0,-4);
\fill [fill=blue!20] (A)-- (C) -- (B) -- (D) -- cycle;
\draw [line width=1pt,dashed] (NX)-- (PX);
\draw [line width=1pt] (A)-- (C) -- (B) -- (D) -- cycle;
\fill [shift={(1.9641016151377546,-0.5980762113533173)},draw=black,line width=1pt,fill=red!20]  plot[domain=1.97449276919821:3.0216903203948076,variable=\t]({1*5*cos(\t r)+0*5*sin(\t r)},{0*5*cos(\t r)+1*5*sin(\t r)}) --cycle;
\fill [shift={(1.9641016151377546,0.5980762113533173)},draw=black,line width=1pt,fill=red!20]  plot[domain=1.97449276919821:3.0216903203948076,variable=\t]({1*5*cos(\t r)+0*5*sin(\t r)},{0*5*cos(\t r)+-1*5*sin(\t r)}) -- cycle;
\fill [shift={(-0.9641016151377559,-2.3301270189221928)},draw=black,line width=1pt,fill=red!20]  plot[domain=0.37245660897304494:1.4196541601696426,variable=\t]({1*6.403124237432849*cos(\t r)+0*6.403124237432849*sin(\t r)},{0*6.403124237432849*cos(\t r)+1*6.403124237432849*sin(\t r)}) -- cycle;
\fill [shift={(-0.9641016151377559,2.3301270189221928)},draw=black,line width=1pt,fill=red!20]  plot[domain=0.37245660897304494:1.4196541601696426,variable=\t]({1*6.403124237432849*cos(\t r)+0*6.403124237432849*sin(\t r)},{0*6.403124237432849*cos(\t r)+-1*6.403124237432849*sin(\t r)}) -- cycle;
\foreach \p in {A,B,C,D}
	\fill[fill=black,draw=black,thick] (\p) circle (2.0pt);
\draw[] (0,1.5) node {$S_5$};
\draw[] (-2.5,2.5) node {$S_3$};
\draw[] (3.5,3) node {$S_4$};
\draw[] (0,-1.5) node {$S_5'$};
\draw[] (-2.5,-2.5) node {$S_3'$};
\draw[] (3.5,-3) node {$S_4'$};
...
\begin{minipage}[c]{0.49\linewidth}
\begin{tikzpicture}[scale=0.6]
\coordinate[] (NX) at (-5,0);
\coordinate[] (PX) at (6.5,0);
\coordinate[label=above left:$A$] (A) at (-4,0);
\coordinate[label=above right:$B$] (B) at (5.657,0);
\coordinate[label=above:$C$] (C) at (0,3);
\coordinate[label=below:$D$] (D) at (0,-3);
\fill [fill=blue!20] (A)-- (C) -- (B) -- (D) -- cycle;
\draw [line width=1pt,dashed] (NX)-- (PX);
\draw [line width=1pt] (A)-- (C) -- (B) -- (D) -- cycle;
\fill [shift={(0.5980762113533151,-1.9641016151377555)},draw=black,line width=1pt,fill=red!20]  plot[domain=1.6906986599898821:2.7378962111864795,variable=\t]({1*5*cos(\t r)+0*5*sin(\t r)},{0*5*cos(\t r)+1*5*sin(\t r)}) -- cycle;
\fill [shift={(0.5980762113533151,1.9641016151377555)},draw=black,line width=1pt,fill=red!20]  plot[domain=1.6906986599898821:2.7378962111864795,variable=\t]({1*5*cos(\t r)+0*5*sin(\t r)},{0*5*cos(\t r)+-1*5*sin(\t r)}) -- cycle;
\fill [shift={(0.22991261925239193,-3.398220337846384)},draw=black,line width=1pt,fill=red!20]  plot[domain=0.5595171601172517:1.6067147113138494,variable=\t]({1*6.402349826752878*cos(\t r)+0*6.402349826752878*sin(\t r)},{0*6.402349826752878*cos(\t r)+1*6.402349826752878*sin(\t r)}) -- cycle;
\fill [shift={(0.22991261925239193,3.398220337846384)},draw=black,line width=1pt,fill=red!20]  plot[domain=0.5595171601172517:1.6067147113138494,variable=\t]({1*6.402349826752878*cos(\t r)+0*6.402349826752878*sin(\t r)},{0*6.402349826752878*cos(\t r)+-1*6.402349826752878*sin(\t r)}) -- cycle;
\foreach \p in {A,B,C,D}
	\fill[fill=black,draw=black,thick] (\p) circle (2.0pt);
\draw[] (0,1.5) node {$S_5$};
\draw[] (-2.5,2.5) node {$S_3$};
\draw[] (3.6,2.7) node {$S_4$};
\draw[] (0,-1.5) node {$S_5'$};
\draw[] (-2.5,-2.5) node {$S_3'$};
\draw[] (3.6,-2.7) node {$S_4'$};
\end{tikzpicture}
...
因为 $l'$ 关于 $AB$ 对称, 在 $l'$ 上再任取一点 $C$, 设 $C$ 关于 $AB$ 对称的点为 $D$, 则 $D$ 也在 $l'$ 上. 连接 $AC, CB, BD, DA$, 则 $S_1$ 的面积被分成了三部分: 弦 $AC$ 与弧 $AC$ 围成的面积 $S_3$, 弦 $CB$ 与弧 $CB$ 围成的面积 $S_4$, $\triangle ABC$ 的面积 $S_5$. $S_1'$ 也一样被分成了$S_3',S_4', S_5'$ 三部分. 沿 $AB$ 放一根滑杆, 在 $AC, CB, BD, DA$ 位置上分别放一个连杆, 将 $S_3, S_4, S_3', S_4'$ 的形状画在硬纸板上剪下来, 并粘在对应的连杆上. $A,B$ 可以沿着滑杆左右移动拉伸, 并带动 $C,D$ 上下移动. 在这个过程中, 四个硬纸板面积都不变, 只有 $S_5, S_5'$ 面积发生变化. 而
$$S_5 = \frac{1}{2}AC\cdot CB\cdot \sin\angle ACB ,$$
$AC, CB$ 的长度固定, 所以只有当 $\angle ACB = 90\degree$ 时, $S_5$ 面积最大. 对于任选的 $C$ 点都要满足 $\angle ACB = 90\degree$, 说明曲线 $l'$ 只能是圆.
