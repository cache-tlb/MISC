...
解: 设 $AB$ 与 $CD$ 得交点为 $F$, 并作点 $C$ 关于直线 $AB$ 的对称点 $E$, 连接 $AE, BE, CE, DE$. 立刻得到 $\angle BAE = \angle BAC = 70\degree$, $\angle EAD = \angle EAB - \angle BAD = 35\degree$, $\angle EBA = \angle ABC = 30\degree$, $\angle EBD = \angle ABD - \angle ABE = 35\degree$.
\begin{figure*}[htbp]
\centering
\begin{tikzpicture}[scale=1]
\coordinate[label=left:$A$] (A) at (0,0);
...
\begin{tikzpicture}[scale=1]
\coordinate[label=below left:$A$] (A) at (0,0);
\coordinate[label=below right:$B$] (B) at (7.2,0);
\coordinate[label=above right:$C$] (C) at (10,4);
\coordinate[label=above left:$D$] (D) at (2.8,4);
...
解: 为方便起见, 将 $CD$ 沿横轴平移, 把平行四边形拉成矩形, 各部分面积保持不变. 过 $E,F$ 作矩形各边的平行线, 将矩形分成 4 块, 四块的面积分别为 $a,b,c,d$, 如下图所示.
\begin{figure*}[htbp]
\centering
\begin{tikzpicture}[scale=1]
\coordinate[label=below left:$A$] (A) at (0,0);
\coordinate[label=below right:$B$] (B) at (7.2,0);
\coordinate[label=above right:$C$] (C) at (7.2,4);
...
\fill [fill=red!20] (A)--(E)--(I)--(H)--cycle;
\fill [fill=cyan!20] (B)--(F)--(I)--(E)--cycle;
\fill [fill=blue!20] (D)--(G)--(I)--(H)--cycle;
\fill [fill=orange!20] (C)--(F)--(I)--(G)--cycle;
\draw [line width=1pt] (A) -- (B) -- (C) -- (D) -- cycle;
\draw [line width=1pt] (D) -- (E)-- (F) -- cycle;
...
\node at (6.5,0.5) {$7$};
\node at (6,3.2) {$9$};
\draw[red] (0.8,1) node {$c$};
\draw[cyan] (4.4,1) node {$d$};
\draw[blue] (0.8,3) node {$a$};
\draw[orange] (4.4,3) node {$b$};
\end{tikzpicture}
\end{figure*}
...
d &= 14.
\end{align*}
再由边长比例关系得 $\dfrac{a}{b} = \dfrac{c}{d}$, 可以解出 
\[ a = c = 4, \qquad b = d = 14 .\]
