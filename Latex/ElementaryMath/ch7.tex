...
\foreach \angle[count=\n from 1] in {-5,225,290} {
	\begin{scope}[rotate=\angle]
		\path[draw,line width=0.5pt,dashed,name path global=d\n] (2,0) arc [start angle=0,
			end angle=180,
           x radius=2cm,
           y radius=1cm] ;
		\path[draw,line width=0.5pt,name path global=s\n] (-2,0) arc [start angle=180,
           end angle=360,
           x radius=2cm,
           y radius=1cm] ;
	\end{scope}
...
\InterSec{s1}{s3}{I2};
\InterSec{s3}{s2}{I1};
\draw[fill=red,opacity=0.2] (I1) to [bend right=8.5]  (I2) to [bend left=7,,line width=1pt] (I3) to [bend left=6](I1);
\InterSec{d1}{d2}{J3};
\InterSec{d1}{d3}{J2};
\InterSec{d3}{d2}{J1};
\draw[fill=blue,opacity=0.2] (J1) to [bend right=8.5]  (J2) to [bend left=7] (J3) to [bend left=6] (J1);
