...
//   console.log(gl);
  ...
  const shadowRT = initShadowBuffer(gl, 1024, 1024);
  ...
  function render(now) {
    ...
    gl.framebufferTexture2D(gl.FRAMEBUFFER, gl.DEPTH_ATTACHMENT, gl.TEXTURE_2D, shadowRT.depthTex, 0);
...
function initShadowBuffer(gl, width, height) {
...
function testOffScreenCanvas()
{
    if ('OffscreenCanvas' in window) {
        var canvasInWorker = document.getElementById('workerRenderCanvas');
